  ...
  const filteredProjects = useMemo(() => {
    return projects.filter(project => {
      const matchesSearch = searchQuery === '' ||
        ...
        project.features.some((feature: string) => feature.toLowerCase().includes(searchQuery.toLowerCase()));

      const matchesTech = selectedTechnologies.length === 0 ||
        selectedTechnologies.some((tech: string) => project.technologies.includes(tech));
    ...
    <section id="projects" className="py-20 bg-gray-50 dark:bg-gray-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ProjectSearch
          ...
          onFilter={setSelectedTechnologies}
